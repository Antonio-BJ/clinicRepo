...
$html="
<p align=\"justify\">
<b>AIG Seguros México</b> nos ha encomendado su TRATAMIENTO MÉDICO AMBULATORIO  con motivo del accidente automovilístico recientemente ocurrido.
<br />
<br />
...
";
//Para cualquier duda o comentarios en relación a la firma del finiquito favor de comunicarse a la <b>LINEA AIG</b> en la Ciudad de México al 52-27-90-00 y en el resto de la República Mexicana al  01800 400 9000. Favor de digitar en ambos casos la opción  número 9.
$pdf->writeHTMLCell($w=0, $h=0, $x='', $y='', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
$html="";
...
$image_file = "../../imgs/responsables/firmaCisneros.jpg";
...
/*$html="
    ...
    <br />
    Av. Álvaro Obregón No. 151, Piso 9, Colonia Roma, Delegación Cuauhtémoc, CP. 06700
    <br />
