...
$pdf->write1DBarcode($fol, 'C39', '82', '', '', 15, 0.26, $style, 'C');
...
$pdf->Ln(25);*/
$pdf->SetFont('helvetica', 'B', 12);
$pdf->Cell($w, $h, "Paciente: ".$nombre." ".$paterno." ".$materno." ", $border, $ln=1, $align, $fill, $link, $stretch, $ignore_min_height);
...
$pdf->Ln(5);
$pdf->Cell($w=60, $h, "La encuesta fué llenada", $border, $ln=0, $align, $fill, $link, $stretch, $ignore_min_height);
$pdf->Cell($w=60, $h, "Durante la estancia (   )", $border, $ln=0, $align, $fill, $link, $stretch, $ignore_min_height);
$pdf->Cell($w=20, $h, "En el alta hospitalaria (   )", $border, $ln=1, $align, $fill, $link, $stretch, $ignore_min_height);
$pdf->Ln(5);
...
$html="
     <table cellspacing=\"2\" cellpadding=\"3\">
           ...
           <tr>
           <td bgcolor=\"#E2EFED\">1.- ¿Actualmente la mejoría de su padecimiento la considera?</td>
           ...
           <tr>
           <td >2.- ¿Actualmente usted considera el servicio de MédicaVial?</td>
          <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           ...
           <tr>
           <td bgcolor=\"#E2EFED\">3.- ¿La atención médica hospitalaria que recibio lo considera?</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           ...
           <tr>
           <td>4.- ¿La atención del personal durante su hospitalización fue?</td>
           <td align=\"center\">(    )</td>
           <td align=\"center\">(    )</td>
           <td align=\"center\">(    )</td>
           <td align=\"center\">(    )</td>
           ...
           <tr>
           <td bgcolor=\"#E2EFED\">5.- ¿Cómo considera la información de su padecimiento otorgada por el médico tratante?</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           <td align=\"center\" bgcolor=\"#E2EFED\">(    )</td>
           ...
           <tr>
           <td>6.- ¿Cómo considera la información para su seguimiento otorgada por el médico tratante?</td>
           <td align=\"center\">(    )</td>
           <td align=\"center\">(    )</td>
           <td align=\"center\">(    )</td>
           <td align=\"center\">(    )</td>
...
$pdf->Ln(1);
   $html="
          <table cellspacing=\"2\" cellpadding=\"3\">
            <tr>
                <td >
                  <p>Sugerencias y quejas: Centro de atención permanente MV(CAP) 01 800 999 12 22, 01 800 3 MEDICA (633422), cap@medicavial.com.mx</p>
                </td>                     
             </tr>
          </table>
         ";
