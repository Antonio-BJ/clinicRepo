...
/************************************************************************************************************************************/
    ...
    {              
        try{
            $query="SELECT LES_clave as id, LES_nombreMedic as label from LesionMV where TLE_claveint=".$opcion;
            $result = $this->_db->query($query);
    ...
    {                                     
        try{               
            $query="SELECT Cia_clave as compania from Expediente where Exp_folio='".$folio."'";
            $result = $this->_db->query($query);
             $rs = $result->fetch();
