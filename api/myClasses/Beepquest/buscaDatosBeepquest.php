...
$sql="SELECT Cia_nombrecorto, Exp_completo, Exp_siniestro, Exp_poliza, Exp_reporte FROM Expediente a INNER JOIN Compania b on a.Cia_clave=b.Cia_clave WHERE Exp_folio='$folio' and a.Cia_clave <> 45  and a.Cia_clave <> 15";
