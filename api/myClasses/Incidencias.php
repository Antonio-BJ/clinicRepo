    ...
    public function sendIncidencia($usuario, $unidad, $datos,$cveIncidencia)
    {
        ...
        switch ($tipo) {
            case '1':
                ...
                $correos=array("adominguez@medicavial.com.mx", "sistemasrep2@medicavial.com.mx");
                break;
            case '2':
                $nombreTipo='Personal';
                break;
        ...
        if($unidad!=8){
         if($tipo==1){
            ...
            $mimemail->add_cc("c.arroyo@medicavial.com.mx");
            $mimemail->add_cc("agutierrez@medicavial.com.mx");
            $mimemail->add_cc("mvnormatividad@medicavial.com.mx");  
            ...
            $mimemail->set_to("c.arroyo@medicavial.com.mx");
            // $mimemail->add_cc("scampos@medicavial.com.mx");  
            $mimemail->add_cc("agutierrez@medicavial.com.mx");            
            $mimemail->add_cc("dbermudez@medicavial.com.mx");
            $mimemail->add_cc("adominguez@medicavial.com.mx");
    ...
    public function enviaIncidenciaAdjunto($usr,$uni,$tipo,$severidad,$obs,$arc,$tem,$archivo,$acciones,$uniInc)
    {
        ...
        if($tem!=''||$tem!=NULL){
            if ($_FILES['file']["error"] > 0){
                ...
                if($archivo["type"] == "application/pdf" || $archivo["type"] == "image/jpeg" || $archivo["type"] == "image/gif" || $archivo["type"] == "image/png" || $archivo["type"] == "image/bmp" || $archivo["type"] == "application/vnd.openxmlformats-officedocument.wordprocessingml.document" || $archivo["type"] =="application/msword" || $archivo["type"] == "image/pjpeg" || $archivo["type"] == "image/jpg" || $archivo["type"] == "image/JPG"){
