...
/************************************************************************************************************************************/
    ...
    public function sendIncidencia($usuario, $unidad, $datos,$cveIncidencia)
    {
        ...
        switch ($severidad) {
         ...
         switch ($unidad) {
            case '1':
                $correoOrigen='mvroma_aut@medicavial.com.mx';                
                break;
            case '2':
                $correoOrigen='mvsatelite_aut@medicavial.com.mx';                
                break;
            case '3':
                $correoOrigen='mvperisur_aut@medicavial.com.mx';                
                break;
            case '4':
                $correoOrigen='mvpuebla_aut@medicavial.com.mx';                
                break;
            case '5':
                $correoOrigen='mvmonterrey_aut@medicavial.com.mx';                
                break;
            case '6':
                $correoOrigen='mvmerida_aut@medicavial.com.mx';                
                break;
            case '7':
                $correoOrigen='mvsanluis_aut@medicavial.com.mx';                
                break;
            case '8':
                $correoOrigen='mvoperacion_aut@medicavial.com.mx';                
                break;
            case '86':
                $correoOrigen='mvchihuahua_aut@medicavial.com.mx';                
                break;
            case '184':
                $correoOrigen='mvinterlomas_aut@medicavial.com.mx';                
                break;         
            case '186':
                $correoOrigen='mvveracruz_aut@medicavial.com.mx';                
                break;         
        }

        switch ($unidad) {
            case '1':
                $uniRec='mvroma@medicavial.com.mx';                
                break;
            case '2':
                $uniRec='mvsatelite@medicavial.com.mx';                
                break;
            case '3':
                $uniRec='mvperisur@medicavial.com.mx';                
                break;
            case '4':
                $uniRec='mvpuebla@medicavial.com.mx';                
                break;
            case '5':
                $uniRec='mvmonterrey@medicavial.com.mx';                
                break;
            case '6':
                $uniRec='mvmerida@medicavial.com.mx';                
                break;
            case '7':
                $uniRec='mvsanluis@medicavial.com.mx';                
                break;
            case '8':
                $uniRec='mvoperacion@medicavial.com.mx';                
                break;
            case '86':
                $uniRec='mvchihuahua@medicavial.com.mx';                
                break;
            case '184':
                $uniRec='mvinterlomas@medicavial.com.mx';                
                break;         
            case '186':
                $uniRec='mvveracruz@medicavial.com.mx';                
                break;         
        }
        if($uniIncidencia){

            switch ($uniIncidencia) {
                case '1':
                    $correoUniInc='mvroma@medicavial.com.mx';                
                    break;
                case '2':
                    $correoUniInc='mvsatelite@medicavial.com.mx';                
                    break;
                case '3':
                    $correoUniInc='mvperisur@medicavial.com.mx';                
                    break;
                case '4':
                    $correoUniInc='mvpuebla@medicavial.com.mx';                
                    break;
                case '5':
                    $correoUniInc='mvmonterrey@medicavial.com.mx';                
                    break;
                case '6':
                    $correoUniInc='mvmerida@medicavial.com.mx';                
                    break;
                case '7':
                    $correoUniInc='mvsanluis@medicavial.com.mx';                
                    break;
                case '8':
                    $correoUniInc='mvoperacion@medicavial.com.mx';                
                    break;
                case '86':
                    $correoUniInc='mvchihuahua@medicavial.com.mx';                
                    break;
                case '184':
                    $correoUniInc='mvinterlomas@medicavial.com.mx';                
                    break;         
                case '186':
                    $correoUniInc='mvveracruz@medicavial.com.mx';                
                    break;         
            }
        }
        try{
        ...
        $contenido='<HTML>
                                ...
                                <table class="table1" border="1" style="width: 100%; border: 1px solid #000;">
                                    ...
                                    <tr>
                                        ...
                                        if($uniIncidencia!=null){
                                             $query="select Uni_nombrecorto from Unidad                                                    
                                                    where Uni_clave='".$uniIncidencia."'";
                                            $result = $this->_db->query($query);
                                            $rs = $result->fetch();
                                            $uniNom = $rs['Uni_nombrecorto'];
                                            $contenido.='<tr><td colspan="2">
                                            Unidad : <b>'.utf8_decode($uniNom).'</b>
                                        </td></tr>';
                                        }
                                $contenido.='                                       
                                </table>
        ...
        if($correoUniInc){
            $mimemail->add_cc($correoUniInc);
        }            
        //$mimemail->set_cc('agutierrez@medicavial.com.mx');   
        //$mimemail->add_cc('egutierrez@medicavial.com.mx');        
        $mimemail->set_subject("- Incidencia - ".$uniNombre." - ".$usuario);
...
/************************************************************************************************************************************/
    ...
    public function enviaIncidenciaAdjunto($usr,$uni,$tipo,$severidad,$obs,$arc,$tem,$archivo,$acciones,$uniInc)
    {
        $mimemail = new nomad_mimemail();  
        $cveIncidencia = $this->generateRandomString(5);
        ...
        switch ($unidad) {
            case '1':
                $uniRec='mvroma_aut@medicavial.com.mx';                
                break;
            case '2':
                $uniRec='mvsatelite_aut@medicavial.com.mx';                
                break;
            case '3':
                $uniRec='mvperisur_aut@medicavial.com.mx';                
                break;
            case '4':
                $uniRec='mvpuebla_aut@medicavial.com.mx';                
                break;
            case '5':
                $uniRec='mvmonterrey_aut@medicavial.com.mx';                
                break;
            case '6':
                $uniRec='mvmerida_aut@medicavial.com.mx';                
                break;
            case '7':
                $uniRec='mvsanluis_aut@medicavial.com.mx';                
                break;
            case '8':
                $uniRec='mvoperacion_aut@medicavial.com.mx';                
                break;
            case '86':
                $uniRec='mvchihuahua_aut@medicavial.com.mx';                
                break;
            case '184':
                $uniRec='mvinterlomas_aut@medicavial.com.mx';                
                break;         
            case '186':
                $uniRec='mvveracruz_aut@medicavial.com.mx';                
                break;         
        }
