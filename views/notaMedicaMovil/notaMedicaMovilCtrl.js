...
if($rootScope.uniClave==1||$rootScope.uniClave==3||$rootScope.uniClave==2||$rootScope.uniClave==184||$rootScope.uniClave==4||$rootScope.uniClave==86||$rootScope.uniClave==7||$rootScope.uniClave==5||$rootScope.uniClave==186||$rootScope.uniClave==6||$rootScope.uniClave==8){
  ...
  /***************************     Estatus de la ntoa Médica        **********************/ 
        ...
        $http.get('api/detallePx.php?funcion=getDatosPersonales&fol='+$rootScope.folio).success(function (data){  
          ...
          $scope.detalle.diagnostico = data.ObsNot_diagnosticoRx;              
...
/***************************    fin Estatus de la ntoa Médica        **********************/
        ...
        $scope.agregaDiagnostico = function(diag){            
         ...
         if($scope.diagnostico.diagnostico!=''|| $scope.diagnostico.diagNoSin!=''){
          ...
          $scope.msjPalabraProhi=false;          
            $http({
            url:'api/api.php?funcion=guardaDiagnosticoMovil&fol='+$rootScope.folio,
            method:'POST', 
            contentType: 'application/json', 
            dataType: "json", 
        ...
        $scope.enviaDatos = function(){  
          ...
          $scope.pase.diagnostico = $scope.detalle.diagnostico;
          ...
          data: $scope.pase
            ...
            var uri = 'api/classes/pdf/generaPDF.php?fol='+$rootScope.folio;
        ...
        $scope.agregarPronostico = function(valor){ 
          ...
          $scope.opcionPron='';
            ...
            if($scope.diagnostico.pronostico==''){

                $scope.diagnostico.pronostico=$scope.opcionPron;

            }else{

                $scope.diagnostico.pronostico=$scope.diagnostico.pronostico+', '+$scope.opcionPron;
