app.controller('documentosMovilCtrl', function($scope,$rootScope,$location,$cookies,busquedas,$http,webStorage) {
  ...
  $scope.nombreMedico='';
  $scope.sexoMed='';
  $scope.cargadorClass ='panel panel-default csspinner traditional';
    ...
    busquedas.medico().success(function(data){
      console.log(data);
      $scope.nombreMedico=data[0].Medico;
      if(data[0].Med_sexo=="M"){
        $scope.sexoMed="soy el Dr.";
      }else{
        $scope.sexoMed="soy la Dra.";
      }
    });
    ...
    $http.get('api/detallePx.php?funcion=getDatosPersonalesMovil&fol='+$rootScope.folio).success(function (data){  
                      ...
                      $scope.detalle.telAdic = data.datos.HA_telAdicional;

                      $scope.detalle.medio = data.datos.HA_medio;
  ...
  $http.get('api/api.php?funcion=getProducto&folio='+$rootScope.folio).success(function (data){
	...
	busquedas.validaNota($rootScope.folio).success(function(data){ 		
        ...
        $scope.cargadorClass ='panel panel-default';
