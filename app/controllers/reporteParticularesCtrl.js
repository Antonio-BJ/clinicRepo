app.controller('reporteParticularesCtrl', function($scope,$rootScope,$location,$cookies,busquedas,$http,webStorage) {
...
$scope.enviaParametros = function(){
    $scope.cargador=true;   
    $http({
        url:'api/Clasificaciones.php?funcion=buscaParametrosReporteParticular&uni='+$rootScope.uniClave,
        method:'POST', 
  ...
  $scope.mandaDocumentos = function(folio){
   ...
   $scope.exportarReporteRegistro = function(){  
            ...
            var uri = 'api/classes/generaExcelRegistroParticulares.php?uni='+$scope.reporte.unidad+
