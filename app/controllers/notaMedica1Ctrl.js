         ...
         if($scope.diagnostico.diagnostico!=''|| $scope.diagnostico.diagNoSin!=''){
          ...
          if($scope.diagnostico.diagNoSin!=''){
            ...
            if($scope.diagnostico.diagnostico==''){
              ...
              $scope.diagnostico.diagnostico = 'DIAGNÓSTICO NO RELACIONADO CON EL SINIESTRO: '+ $scope.diagnostico.diagNoSin;

            }else{

              $scope.diagnostico.diagnostico = $scope.diagnostico.diagnostico+'. DIAGNÓSTICO NO RELACIONADO CON EL SINIESTRO: '+ $scope.diagnostico.diagNoSin;          
...
/*************************          fin  suministro symio         *******************************************/
        ...
        $scope.imprimirNota = function(){           
            ...
            if($scope.ValidaInventario==1){
              ...
              $scope.url= 'api/classes/formatoNota1.php?fol='+$rootScope.folio+'&vit='+$rootScope.vitSelect;

            }else{

              $scope.url='api/classes/formatoNota.php?fol='+$rootScope.folio+'&vit='+$rootScope.vitSelect;
        ...
        $scope.imprimirReceta = function(){  
            ...
            if($scope.ValidaInventario==1){
              ...
              $scope.url= 'api/classes/formatoRecetaNuevo1.php?fol='+$rootScope.folio+'&vit='+$rootScope.vitSelect+'&uni='+$rootScope.uniClave+'&usr='+$rootScope.usrLogin;

            }else{

              $scope.url='api/classes/formatoRecetaNuevo.php?fol='+$rootScope.folio+'&vit='+$rootScope.vitSelect+'&uni='+$rootScope.uniClave+'&usr='+$rootScope.usrLogin;
