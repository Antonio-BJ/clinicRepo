app.controller('recetaExternaCtrl', function($scope,$rootScope,$location,$cookies,busquedas,$http,webStorage,$q) {
    ...
    $scope.trabajando=true;
      ...
      data: {cve:'valor'}
        ...
        $scope.imprimirReceta = function(){
          $scope.trabajando=true;
            console.log('entro');           
            var fileName = 'RecetaExterna-'+$rootScope.folio;
            var uri = 'api/classes/formatoRecetaExterna.php?fol='+$rootScope.folio+'&usr='+$rootScope.usrLogin+'&uni='+$rootScope.uniClave;
