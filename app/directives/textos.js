        ...
        controller: function($scope, $element, busquedas){
            ...
            var createPDF = function(imgData,clave) {
                ...
                busquedas.detalleSolicitud(clave).success(function (data){                 
                  ...
                  //encabezado
                  doc.setFontSize(9);
                  doc.text(160, 10, datos.fechaReg); 
  ...
  //directiva que agrega boton para descargar la receta lo que pongas como atributo
    app.directive('receta1', function(){
        return {
            ...
            scope: true,
            scope: { data: '=' },
            template: '<button ng-click="click(data)" id="genera" ng-hide="veEditaNota"  class="btn btn-info btn-xs" tooltip-placement="top" tooltip-trigger tooltip="Imprimir receta" ><em class="glyphicon fa fa-print"></em></button>',
            controller: function($scope, $element){
                ...
                var createPDF = function(imgData,imgData2,imgData3,qr) {
                    ...
                    doc.setFontSize(10);
                    doc.text(40, 290, 'Cita abierta las 24hrs en caso de continuar con molestas, favor de agendar.');
